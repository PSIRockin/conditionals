...
if (item == 'jacket') {
    money - 40 == money
    health + 20 == health
    console.log ("You bought a jacket." + '\n', "You lost $40 and gained 20 health. You have $" + money + " left.")
}else if (item == 'candy'){
    money - 10 == money
    console.log ("You bought a candy." + '\n', "You lost $10. You have $" + money + " left.")
}else if (item == 'paint'){
    money - 30 == money
    console.log ("You bought some paint." + '\n', "You lost $30. You have $" + money + " left.")
}else if (item == 'hammer'){
    money - 70 == money
    console.log ("You bought a hammer." + '\n', "You lost $70. You have $" + money + " left.")
}else {
    console.log ("..." + '\n', "You walked into the store and bought nothing. What are you, a window shopper?" + '\n', "YOU SHOULDA BOUGHT SOMETHING YOU IDIOT." + '\n', "Well, whatever.")
}
